...
export class CategoryRule implements Rule {
  ...
  constructor(list: Array<string>, singular: string, plural: string) {
    this.list = list
    this.singular = singular
    this.plural = plural
  }
...
export abstract class TwoFormInflector {
  ...
  protected uncountable(list: Array<string>) {
  ...
  protected categoryRule(list: Array<string>, singular: string, plural: string) {
